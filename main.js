...
var $author$project$Main$Candidate = F4(
	function (name, ranking, eliminatedBy, score) {
		return {eliminatedBy: eliminatedBy, name: name, ranking: ranking, score: score};
	});
var $author$project$Main$PossibleCandidate = function (a) {
	return {$: 'PossibleCandidate', a: a};
};
...
function $author$project$Main$cyclic$possibleCandidateDecoder() {
	return A2(
		$elm$json$Json$Decode$map,
		$author$project$Main$PossibleCandidate,
		$elm$json$Json$Decode$nullable(
			$author$project$Main$cyclic$candidateDecoder()));
}
function $author$project$Main$cyclic$candidateDecoder() {
	return A2(
		...
		A2(
			...
			A2(
				...
				$elm$json$Json$Decode$lazy(
					function (_v0) {
						return $author$project$Main$cyclic$possibleCandidateDecoder();
					})),
			A2(
				$elm_community$json_extra$Json$Decode$Extra$andMap,
				A2(
				...
				A2(
					...
					$elm$json$Json$Decode$succeed($author$project$Main$Candidate)))));
}
try {
	var $author$project$Main$possibleCandidateDecoder = $author$project$Main$cyclic$possibleCandidateDecoder();
	$author$project$Main$cyclic$possibleCandidateDecoder = function () {
		return $author$project$Main$possibleCandidateDecoder;
	};
	var $author$project$Main$candidateDecoder = $author$project$Main$cyclic$candidateDecoder();
	$author$project$Main$cyclic$candidateDecoder = function () {
		return $author$project$Main$candidateDecoder;
	};
} catch ($) {
...
var $author$project$Main$ShowPairing = {$: 'ShowPairing'};
var $author$project$Main$stateDecoder = function () {
	var stringToState = function (str) {
		switch (str) {
			case 'NoNames':
				return $elm$json$Json$Decode$succeed($author$project$Main$NoNames);
			case 'Preview':
				return $elm$json$Json$Decode$succeed($author$project$Main$Preview);
			case 'ShowPairing':
				return $elm$json$Json$Decode$succeed($author$project$Main$ShowPairing);
			case 'Done':
...
var $author$project$Main$init = function (data) {
	return _Utils_Tuple2(
		$author$project$Main$decodeModel(data),
...
var $author$project$Main$keyToMsg = function (string) {
	switch (string) {
		case 'ArrowRight':
			return $author$project$Main$Pressed($author$project$Main$Right);
		case 'ArrowLeft':
			return $author$project$Main$Pressed($author$project$Main$Left);
		case 'ArrowUp':
			return $author$project$Main$Pressed($author$project$Main$Middle);
		case 'ArrowDown':
			return $author$project$Main$Pressed($author$project$Main$Middle);
		default:
...
var $author$project$Main$nameToCandidate = function (name) {
	return {
		...
		name: name,
		ranking: $elm$core$Maybe$Nothing,
		score: 1
	};
};
var $elm$core$Basics$not = _Basics_not;
var $elm$core$String$trim = _String_trim;
var $author$project$Main$namesToCandidates = function (names) {
	var trimmed = A2($elm$core$List$map, $elm$core$String$trim, names);
	var filtered = A2(
		...
		if (!available.b) {
			...
			if (!available.b.b) {
				...
				return $author$project$Main$Next(
					A2($elm$core$List$take, number, sorted));
			}
		}
	});
...
var $author$project$Main$shuffleCandidatesCommand = function (candidates) {
	return A2(
		$elm$random$Random$generate,
		$author$project$Main$Shuffled,
		$elm_community$random_extra$Random$List$shuffle(candidates));
};
...
var $author$project$Main$encodeCandidate = function (_v2) {
	var name = _v2.name;
	var ranking = _v2.ranking;
	var score = _v2.score;
	var eliminatedBy = _v2.eliminatedBy;
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				...
				_Utils_Tuple2(
				'ranking',
				A2($author$project$Main$encodeMaybe, $elm$json$Json$Encode$int, ranking)),
				_Utils_Tuple2(
				'eliminatedBy',
				$author$project$Main$encodePossibleCandidate(eliminatedBy)),
				_Utils_Tuple2(
				'score',
				$elm$json$Json$Encode$int(score))
			]));
};
var $author$project$Main$encodePossibleCandidate = function (possibleCandidate) {
	var unwrapped = function () {
		var c = possibleCandidate.a;
		return c;
	}();
	if (unwrapped.$ === 'Nothing') {
		...
		var c = unwrapped.a;
		return $author$project$Main$encodeCandidate(c);
	}
};
	...
	return $elm$json$Json$Encode$object(
		_List_fromArray(
			[
				_Utils_Tuple2(
				'state',
				$author$project$Main$encodeState(state)),
				_Utils_Tuple2(
				'candidates',
				A2($elm$json$Json$Encode$list, $author$project$Main$encodeCandidate, candidates)),
				_Utils_Tuple2(
				'choices',
				A2($elm$json$Json$Encode$list, $author$project$Main$encodeCandidate, choices)),
				_Utils_Tuple2(
				'round',
...
var $author$project$Main$storeModel = function (model) {
	return $author$project$Main$storage(
		$author$project$Main$encodeModel(model));
};
var $author$project$Main$updateWithStore = function (model) {
	return _Utils_Tuple2(
		model,
		$author$project$Main$storeModel(model));
};
var $author$project$Main$resolveNextPairing = function (model) {
	var _v0 = A2($author$project$Main$getPairing, 3, model.candidates);
	switch (_v0.$) {
		case 'Next':
			var choices = _v0.a;
			return $author$project$Main$updateWithStore(
				_Utils_update(
					model,
					{choices: choices, round: model.round + 1, state: $author$project$Main$ShowPairing}));
		case 'Impossible':
			return $author$project$Main$updateWithStore(
				_Utils_update(
					model,
		...
		default:
			var last = _v0.a;
			var resolveCandidate = function (candidate) {
				if (_Utils_eq(candidate, last)) {
					return _Utils_update(
						candidate,
						{
							ranking: $elm$core$Maybe$Just(model.currentPosition)
						});
				} else {
					var _v1 = candidate.eliminatedBy;
					var pc = _v1.a;
					if (pc.$ === 'Just') {
						var c = pc.a;
						return _Utils_eq(c.name, last.name) ? _Utils_update(
							candidate,
							{
								eliminatedBy: $author$project$Main$PossibleCandidate($elm$core$Maybe$Nothing)
							}) : candidate;
			...
			var resolvedCandidates = A2($elm$core$List$map, resolveCandidate, model.candidates);
			var newModel = _Utils_update(
				model,
				{candidates: resolvedCandidates, currentPosition: model.currentPosition + 1});
			return _Utils_Tuple2(
				newModel,
				$author$project$Main$shuffleCandidatesCommand(newModel.candidates));
	}
};
var $author$project$Main$resolvePick = F2(
	function (model, picked) {
		var loosers = A2(
			$elm$core$List$filter,
			A2(
				$elm$core$Basics$composeR,
				$elm$core$Basics$eq(picked),
				$elm$core$Basics$not),
			model.choices);
		var newScore = A3(
			$elm$core$List$foldl,
			...
			A2(
				...
				loosers));
		var resolveCandidate = F2(
			function (choice, candidate) {
				return _Utils_eq(candidate, choice) ? (_Utils_eq(choice, picked) ? _Utils_update(
					candidate,
					{score: newScore}) : _Utils_update(
					candidate,
					{
						eliminatedBy: $author$project$Main$PossibleCandidate(
							$elm$core$Maybe$Just(picked))
					})) : candidate;
			});
		var resolveChoice = F2(
			function (choice, candidates) {
				return A2(
					$elm$core$List$map,
					resolveCandidate(choice),
					candidates);
			});
		var newCandidates = A3($elm$core$List$foldl, resolveChoice, model.candidates, model.choices);
...
var $author$project$Main$renderHeading = F2(
	function (h, txt) {
		return A2(
			h,
			_List_Nil,
...
var $author$project$Main$renderConfirm = function (model) {
	return _List_fromArray(
		[
			A2($author$project$Main$renderHeading, $elm$html$Html$h2, 'Theese are the candidates to be ranked'),
			A2(
			$elm$html$Html$ul,
			_List_Nil,
			A2(
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$Events$onClick($author$project$Main$PreviewConfirm),
							$elm$html$Html$Attributes$class('primary')
						]),
					_List_fromArray(
						[
							$elm$html$Html$text('Start ranking')
						]))
				]))
		]);
};
var $elm$html$Html$ol = _VirtualDom_node('ol');
var $author$project$Main$renderRankedItem = function (candidate) {
	var _v0 = candidate.ranking;
	if (_v0.$ === 'Nothing') {
...
var $author$project$Main$sortByRank = F2(
	function (c1, c2) {
		var _v0 = c1.ranking;
		if (_v0.$ === 'Nothing') {
			...
			if (_v1.$ === 'Nothing') {
				...
				var r2 = _v1.a;
				return A2($elm$core$Basics$compare, r1, r2);
			}
		}
	});
var $elm$core$List$sortWith = _List_sortWith;
var $author$project$Main$renderRankings = function (candidates) {
	return A2(
		$elm$html$Html$ol,
		_List_Nil,
		A2(
			$elm$core$List$map,
			$author$project$Main$renderRankedItem,
			A2($elm$core$List$sortWith, $author$project$Main$sortByRank, candidates)));
};
var $author$project$Main$renderDone = function (model) {
	return _List_fromArray(
		[
			$elm$html$Html$text(
			'You are done in ' + ($elm$core$String$fromInt(model.round) + ' rounds!')),
...
var $author$project$Main$renderPairing = function (model) {
	return _List_fromArray(
		[
			...
			_List_fromArray(
				[
					$elm$html$Html$text('From the candidates below choose the one which you like the best')
				])),
			A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					$elm$html$Html$Attributes$class('picking')
				]),
			_List_fromArray(
				[
					A2(
					...
					$author$project$Main$renderPairingCandidates(model.choices)),
					A2(
					$elm$html$Html$div,
					_List_fromArray(
						[
							$elm$html$Html$Attributes$class('rankings')
						]),
					_List_fromArray(
						[
							$author$project$Main$renderRankings(model.candidates)
...
var $author$project$Main$RawCandidates = function (a) {
	return {$: 'RawCandidates', a: a};
};
...
var $author$project$Main$renderSetup = function (model) {
	return _List_fromArray(
		[
			A2($author$project$Main$renderHeading, $elm$html$Html$h2, 'Welcome to BRT'),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('First you need to enter some boardgames to rank')
				])),
			A2(
			$elm$html$Html$p,
			_List_Nil,
			_List_fromArray(
				[
					$elm$html$Html$text('Please enter all boardgames to rank in the area below, putting each boardgame name on its own line')
				])),
			A2(
			...
			_List_fromArray(
				[
					...
					$elm$html$Html$Events$onInput($author$project$Main$RawCandidates)
				]),
			_List_Nil),
			A2(
			$elm$html$Html$p,
					...
					$elm$core$String$concat(
						_List_fromArray(
							[
								...
								$elm$core$List$length(model.candidates)),
								' candidates'
							])))
				])),
			A2(
...
var $author$project$Main$renderMain = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		function () {
			...
			switch (_v0.$) {
				case 'NoNames':
					return $author$project$Main$renderSetup(model);
				case 'Preview':
					return $author$project$Main$renderConfirm(model);
				case 'ShowPairing':
					return $author$project$Main$renderPairing(model);
				default:
					return $author$project$Main$renderDone(model);
			}
		}());
};
